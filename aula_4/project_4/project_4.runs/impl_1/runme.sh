...
HD_PWD='C:/Users/Labmicro7/Music/Edu_Fred/aula_4/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eq_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eq_top.tcl -notrace
