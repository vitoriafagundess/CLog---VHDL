...
HD_PWD='C:/Users/Labmicro7/Music/Edu_Fred/aula_4/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eq_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eq_top.tcl
